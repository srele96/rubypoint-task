...
The computed $s_init$ lies on $B_0$, $B_1$ segment.
...
\begin{align*}
    ...
    P &= B_0 + s_init v  \\
    A &= A_0 \\
    P - A &= B_0 + s_init v - A_0 \\
    P - A &= -(A_0 - B_0) + s_init v \\
    w_0 &= A_0 - B_0 \\
    P - A &= - w_0 + s_init v \\
    P - A &= s_init v - w_0 \\
    m &= u \\
    Q &= A_0 + \frac{(s_init v - w_0) \cdot m}{m \cdot m} \cdot m \\
    Q &= A_0 + \frac{(s_init v - w_0) \cdot u}{u \cdot u} \cdot u \\
    Q &= A_0 + \frac{s_init v \cdot u - w_0 \cdot u}{u \cdot u} \cdot u \\
    b &= v \cdot u \\
    d &= w_o \cdot u  \\
    a &= u \cdot u \\
    Q &= A_0 + \frac{s_init (v \cdot u) - (w_0 \cdot u)}{(u \cdot u)} \cdot u \\
    Q &= A_0 + \frac{s_init b - d}{a} \cdot u \\
    k &= clamp(\frac{s_init b - d}{a}, 0, 1) \\
    Q &= A_0 + k \cdot u \\
\end{align*}
